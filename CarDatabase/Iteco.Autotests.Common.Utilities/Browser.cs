...
namespace Iteco.Autotests.Common.Utilities
{
    ...
    public static class Browser
    {
        ...
        private static ChromeDriver StartChrome()
        {
            ...
            var field = chromeOptions.GetType().GetField("additionalCapabilities", BindingFlags.Instance | BindingFlags.NonPublic);
            
            if (field != null)
            {
                var dict = field.GetValue(chromeOptions) as IDictionary<string, object>;
