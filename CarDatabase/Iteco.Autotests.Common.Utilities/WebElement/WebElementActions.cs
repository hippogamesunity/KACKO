...
namespace Iteco.Autotests.Common.Utilities.WebElement
{
    ...
    public partial class WebElement
    {
        ...
        public string Value
        {
            get { return FindSingle().GetAttribute("value"); }
        }
        ...
        public bool Checked
        {
            get { return GetAttribute(TagAttributes.Checked) == "true"; }
        }
        ...
        public WebElement First(Func<WebElement, bool> action)
        {
            return Where(action).First();
        }
